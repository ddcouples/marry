...
var MARGIN_TOP=160;
var MARGIN_LEFT=30;
var YEAR=2017,MONTH=0,DAY=7;HOUR=9,MIN=0,SEC=0,days=0;
const endTime=new Date(YEAR,MONTH,DAY,HOUR,MIN,SEC);
var curShowTimeSeconds=0;
var balls=[];
var Daytext="张代龙&杜佳荣的婚礼";
var fontTextLeft="~河南潢川~ 欢迎您的到来！";
var soundNum=3,a=0;

var fontTextRight="—张代龙&杜佳荣";
var img=[];
var imgbgNum=17;
var audio=[];
...
function doGranule(){
  ...
  var defaultoptions = {
	        ...
	        ga.draw(function(){
	        	over=true;
	        	if(over&&window.location.href===oldUrl){
	        		setTimeout(function(){
