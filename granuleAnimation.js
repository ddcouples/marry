...
GranuleAnimation.prototype.calculate = function () {
    ...
    ctx.strokeText(Daytext,MARGIN_LEFT+80,MARGIN_TOP/3+70);
    var text1=" 还剩 "+days+" 天 零";
...
// 绘图案
GranuleAnimation.prototype.draw = function (cb) {
    ...
    function drawText(cb){
        ...
        ctx.fillText(Daytext,MARGIN_LEFT+80,MARGIN_TOP/3+70);
